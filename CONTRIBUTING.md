...
感谢您对本项目的关注！无论你是发现了一个错误日期，还是想补充一段被遗漏的足迹，你的每一次贡献，都在让历史画卷更加完整。
...
为保证项目质量，所有贡献都应遵循以下标准。我们依据事件的历史意义将其分为三级，这决定了事件在历史叙事中的权重。
...
欢迎在 [GitHub Issues](https://github.com/sansan0/mao-map/issues) 中参与讨论，或者公众号 **【硅基茶水间】** 留言
